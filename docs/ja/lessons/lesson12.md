...
> 詳しくは [第4回 クリッピング](/ja/lessons/lesson04#クリッピング-max-min-clip) を参照してください。
...
> 詳しくは [第4回 平滑化（スムージング）](/ja/lessons/lesson04#平滑化-スムージング) を参照してください。
...
| **作品名** | 作品のタイトル | 海中散歩 |
| **作者名** | 自分の名前 | 山田太郎 |
| **コンセプト説明** | 作品の意図を説明 | 深海の世界を音で表現した。micro:bitの傾きで水深が変わり、暗さで泡が出現する。 |
